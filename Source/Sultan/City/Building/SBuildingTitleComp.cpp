...
#include "SBuildingTitleComp.h"

// Sets default values for this component's properties
USBuildingTitleComp::USBuildingTitleComp()
{
	...
	//208, 181, 126
	Title->SetTextRenderColor(FColor(208, 181, 126));
...
void USBuildingTitleComp::BeginPlay()
{
	Super::BeginPlay();
...
void USBuildingTitleComp::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
