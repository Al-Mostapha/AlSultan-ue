...
#include "SBuildingProgWid.h"

USBuildingProgWid::USBuildingProgWid(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
}

void USBuildingProgWid::NativeConstruct()
{
...
void USBuildingProgWid::UpdateComboCount(int32 Value)
{
...
void USBuildingProgWid::ResetCombo()
{
...
void USBuildingProgWid::StoreWidgetAnimations()
{
	AnimationsMap.Empty();
...
UWidgetAnimation* USBuildingProgWid::GetAnimationByName(FName AnimationName) const
{
